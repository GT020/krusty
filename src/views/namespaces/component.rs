...
use crate::k8s::context::use_is_connected;
...
pub fn NamespacesPage() -> Element {
    ...
    use_effect(move || {
        ...
        spawn(async move {
            let mut stream = client::watch_namespaces().await;
    ...
    rsx! {
        div { class: "flex-1 flex flex-col",
            ResourcePageHeader { display_name: "Namespaces".to_string(), on_clear: move |_| resources.write().clear() }
