...
#[component]
pub fn StatefulSetsPage() -> Element {
    ...
    use_effect(move || {
        ...
        spawn(async move {
            ...
            let mut stream = client::watch_statefulsets(namespace).await;
    ...
    rsx! {
        div { class: "flex-1 flex flex-col",
            ResourcePageHeader { display_name: "StatefulSets".to_string(), on_clear: move |_| resources.write().clear() }
