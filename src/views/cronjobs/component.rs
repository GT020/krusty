...
pub fn CronJobsPage() -> Element {
    ...
    use_effect(move || {
        ...
        spawn(async move {
            ...
            let mut stream = client::watch_cronjobs(namespace).await;
    ...
    rsx! {
        div { class: "flex-1 flex flex-col",
            ResourcePageHeader { display_name: "CronJobs".to_string(), on_clear: move |_| resources.write().clear() }
